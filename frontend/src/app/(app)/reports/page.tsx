...
export default function ReportsPage() {
  ...
  async function download() {
    ...
    try {
      const report = await caseApi.reportPdf(currentCase.backendId);
      const url = URL.createObjectURL(report);
      const link = document.createElement("a");
      link.href = url;
      link.download = `ip-sakti-case-${currentCase.backendId}.pdf`;
      link.click();
